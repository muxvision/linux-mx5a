...
static int option_huawei_connected = 0;
...
int option_get_huawei_connected(void)
{
	return option_huawei_connected;
}
EXPORT_SYMBOL(option_get_huawei_connected);
